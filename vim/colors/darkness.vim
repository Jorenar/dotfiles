...
hi! Pmenu           cterm=NONE            ctermfg=249   ctermbg=234
...
hi! StatusLine      cterm=NONE            ctermfg=250   ctermbg=233
hi! StatusLineNC    cterm=NONE            ctermfg=236   ctermbg=232
hi! StatusLineTerm  cterm=NONE            ctermfg=0     ctermbg=121
hi! TabLine         cterm=NONE            ctermfg=240   ctermbg=233
hi! TabLineFill     cterm=NONE            ctermfg=249   ctermbg=233
hi! TabLineSel      cterm=NONE            ctermfg=249   ctermbg=bg
...
hi! VertSplit       cterm=NONE            ctermfg=240   ctermbg=NONE
